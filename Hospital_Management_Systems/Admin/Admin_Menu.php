...
<div class="menu-container">
    ...
    <button class="menu-btn" onclick="loadPage('http://localhost/Hospital_Management_Systems/Admin/Admin_Dashboard.php', this)">
    ...
    <div class="dropdown" id="roomsDropdown">
        <button class="menu-btn" onclick="loadPage('http://localhost/Hospital_Management_Systems/Admin/Add_Rooms.php', this)">Add Rooms</button>
    ...
    <div class="dropdown" id="reportingDropdown">
        ...
        <button class="menu-btn" onclick="loadPage('http://localhost/Hospital_Management_Systems/Reception/Reports/Lab_Reports.php', this)">Lab Tests</button>
