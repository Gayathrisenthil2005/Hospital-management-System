...
$lab_technicians_count = getTotalCount($conn, "employees", "department = 'Lab'");
...
$total_rooms = getTotalCount($conn, "rooms");
...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="card">
            <h3>Total Lab Technicians</h3>
            <p><?php echo $lab_technicians_count; ?></p>
        </div>
        <div class="card">
